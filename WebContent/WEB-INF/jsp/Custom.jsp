	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="custom/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${custom['id'] }"> 
					<ul class="forminfo">
						<li><label>姓名<b>*</b></label><input id="name" value="${custom['name'] }"
							name="name" type="text" class="dfinput" placeholder="请填写姓名"
							style="width: 518px;" /></li>
						<li><label>年龄<b>*</b></label><input id="age" value="${custom['age'] }"
						...
						<li><label>地址<b>*</b></label><input id="address" value="${custom['address'] }"
							name="address" type="text" class="dfinput" placeholder="请填写地址"
							style="width: 518px;" /></li>
						<li><label>担保信息<b>*</b></label><input id="pledge" value="${custom['pledge'] }"
							name="pledge" type="text" class="dfinput" placeholder="请填写担保信息"
							style="width: 518px;" /></li>
						<li><label>驾驶证号<b>*</b></label><input id="card" value="${custom['card'] }"
							name="card" type="text" class="dfinput" placeholder="请填写驾驶证号"
							style="width: 518px;" /></li>
						<li><label>详细描述<b>*</b></label><textarea name="remark" id="content7">${custom['remark'] }</textarea></li>
