	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="bargain/informationUpdate" method="POST"
					...
					<ul class="forminfo">
						<li><label>客户姓名<b>*</b></label><div class="vocation">
						 <select class="select3" name="custom_id" id="custom_id">
									<c:forEach items="${customList }" var="custom">
											<c:if test="${custom['id'] eq bargain['custom']['id']}" var="s1">
						...
						<li><label>租赁汽车<b>*</b></label><div class="vocation">
						 <select class="select3" name="car_id" id="car_id">
									<c:forEach items="${carList }" var="car">
											<c:if test="${car['id'] eq bargain['car']['id']}" var="s2">
												<option value="${car['id'] }" selected="selected">${car['name'] }</option>
											</c:if>
											<c:if test="${!s2}">
						...
						<li><label>详细描述<b>*</b></label><textarea name="remark" id="content7">${bargain['remark'] }</textarea></li>
