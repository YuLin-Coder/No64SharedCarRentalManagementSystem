	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="type/informationAdd" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" value="1" name="typee">
					<ul class="forminfo">
						<li><label>汽车类型<b>*</b></label><input id="name" 
							name="name" type="text" class="dfinput" placeholder="请填写汽车类型"
