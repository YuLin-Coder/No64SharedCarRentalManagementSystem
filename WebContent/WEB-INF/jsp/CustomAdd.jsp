	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="custom/informationAdd" method="POST"
					onsubmit="return checkSubmit();">
					<ul class="forminfo">
						<li><label>姓名<b>*</b></label><input id="name" 
							name="name" type="text" class="dfinput" placeholder="请填写姓名"
							style="width: 518px;" /></li>
						<li><label>年龄<b>*</b></label><input id="age" 
						...
						<li><label>地址<b>*</b></label><input id="address" 
							name="address" type="text" class="dfinput" placeholder="请填写地址"
							style="width: 518px;" /></li>
						<li><label>担保信息<b>*</b></label><input id="pledge" 
							name="pledge" type="text" class="dfinput" placeholder="请填写担保信息"
							style="width: 518px;" /></li>
						<li><label>驾驶证号<b>*</b></label><input id="card" 
