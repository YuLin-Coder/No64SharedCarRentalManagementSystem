	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="car/informationAdd" method="POST" enctype="multipart/form-data"
					onsubmit="return checkSubmit();">
					<ul class="forminfo">
						<li><label>车辆名称<b>*</b></label><input id="name" 
							name="name" type="text" class="dfinput" placeholder="请填写车辆名称"
							style="width: 518px;" /></li>
						<li><label>车牌号码<b>*</b></label><input id="code" 
							name="code" type="text" class="dfinput" placeholder="请填写车辆品牌"
							style="width: 518px;" /></li>
						<li><label>车辆品牌<b>*</b></label><input id="factory" 
							name="factory" type="text" class="dfinput" placeholder="请填写车辆品牌"
							style="width: 518px;" /></li>
						<li><label>座位数<b>*</b></label><input id="stand" 
							name="stand" type="text" class="dfinput" placeholder="请填写座位数"
							style="width: 518px;" /></li>
						<li><label>所在地址<b>*</b></label><input id="address" 
							name="address" type="text" class="dfinput" placeholder="请填写所在地址"
							style="width: 518px;" /></li>
						<li><label>租赁价格<b>*</b></label><input id="price" 
