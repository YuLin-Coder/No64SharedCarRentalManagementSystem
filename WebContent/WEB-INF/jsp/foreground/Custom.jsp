...
<form id="jobform" method="post" action="custom/informationUpdateFore" name="jobform">
...
<tr> 
     ...
     <tr> 
      <td width="80" align="right">年   龄：</td>
      <td> 
	...
	<tr> 
      ...
      <td> 
       <input type="text" name="address" value="${custom['address'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
    <tr> 
      <td width="80" align="right">担保信息：</td>
      <td> 
       <input type="text" name="pledge" value="${custom['pledge'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
	<tr> 
      <td width="80" align="right">驾驶证号：</td>
      <td> 
       <input type="text" name="card" value="${custom['card'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
	<tr> 
    ...
    <tr> 
      ...
      <td height="30">
        <input type="submit" name="ccc" value="提交" class="submit">
    		<input type="hidden" name="flag" value="1" class="input" style="width:200px" />
