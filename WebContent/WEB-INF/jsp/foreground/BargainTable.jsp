...
<table width="100%" border="0" cellpadding="3" cellspacing="0" class="shopcart">
		  <tr >
		    <td class="cap">&nbsp;</td> 
			<td class="cap">车辆名称</td>
			<td class="cap">租车日期</td>
			<td class="cap">当前费用</td>
			<td class="cap">归还日期</td>
			<td class="cap">订单状态</td>
			<td class="cap">操作</td>
		  </tr>
		  <c:forEach items="${pager.datas }" var="bargain" varStatus="vs">
                ...
                <td>
                <c:if test="${bargain['status'] eq 0}" var="t1">
                <a href="bargain/backFore?id=${bargain['id'] }">归还</a>
                </c:if>
                <c:if test="${!t1 }">
                		暂无
                </c:if>
