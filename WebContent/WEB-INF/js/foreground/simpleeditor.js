...
var KE_HEIGHT = "300px";
var KE_SITE_DOMAIN = "";
var KE_SKIN_PATH  = "http://demo.vhostgo.com/kedit/skins/default/";
var KE_ICON_PATH = "http://demo.vhostgo.com/kedit/icons/";
var KE_IMAGE_ATTACH_PATH = "http://demo.vhostgo.com/base/images/";
var KE_IMAGE_UPLOAD_CGI = "http://demo.vhostgo.com/kedit/upload_cgi/upload.php";
var KE_CSS_PATH = "http://demo.vhostgo.com/kedit/style.css";
...
var KE_TOP_TOOLBAR_ICON = Array(
	Array('KE_SOURCE', 'source.html', '视图转换'),
	Array('KE_PREVIEW', 'preview.html', '预览'),
	//Array('KE_ZOOM', 'zoom.gif', '显示比例'),
	//Array('KE_PRINT', 'print.gif', '打印'),
	Array('KE_UNDO', 'undo.html', '回退'),
	Array('KE_REDO', 'redo.html', '前进'),
	Array('KE_CUT', 'cut.html', '剪切'),
	Array('KE_COPY', 'copy.html', '复制'),
	Array('KE_PASTE', 'paste.html', '粘贴'),
	Array('KE_SELECTALL', 'selectall.html', '全选'),
	Array('KE_JUSTIFYLEFT', 'justifyleft.html', '左对齐'),
	Array('KE_JUSTIFYCENTER', 'justifycenter.html', '居中'),
	Array('KE_JUSTIFYRIGHT', 'justifyright.html', '右对齐'),
	Array('KE_JUSTIFYFULL', 'justifyfull.html', '两端对齐'),
	Array('KE_NUMBEREDLIST', 'numberedlist.html', '编号'),
	Array('KE_UNORDERLIST', 'unorderedlist.html', '项目符号'),
	Array('KE_INDENT', 'indent.html', '减少缩进'),
	Array('KE_OUTDENT', 'outdent.html', '增加缩进'),
	Array('KE_SUBSCRIPT', 'subscript.html', '下标'),
	Array('KE_SUPERSCRIPT', 'superscript.html', '上标'),
	Array('KE_SPECIALCHAR', 'specialchar.html', '特殊字符'),
	Array('KE_DATE', 'date.html', '日期'),
	Array('KE_TIME', 'time.html', '时间')
);
var KE_BOTTOM_TOOLBAR_ICON = Array(
	Array('KE_TITLE', 'title.html', '标题'),
	Array('KE_FONTNAME', 'font.html', '字体'),
	Array('KE_FONTSIZE', 'fontsize.html', '文字大小'),
	Array('KE_TEXTCOLOR', 'textcolor.html', '文字颜色'),
	Array('KE_BGCOLOR', 'bgcolor.html', '文字背景'),
	Array('KE_BOLD', 'bold.html', '粗体'),
	Array('KE_ITALIC', 'italic.html', '斜体'),
	Array('KE_UNDERLINE', 'underline.html', '下划线'),
	Array('KE_STRIKE', 'strikethrough.html', '删除线'),
	Array('KE_REMOVE', 'removeformat.html', '删除格式'),
	Array('KE_IMAGE', 'image.html', '图片'),
	Array('KE_FLASH', 'flash.html', 'Flash'),
	Array('KE_MEDIA', 'media.html', 'Windows Media Player'),
	Array('KE_REAL', 'real.html', 'Real Player'),
	Array('KE_LAYER', 'layer.html', '层'),
	Array('KE_TABLE', 'table.html', '表格'),
	Array('KE_HR', 'hr.html', '横线'),
	Array('KE_ICON', 'emoticons.html', '笑脸'),
	Array('KE_LINK', 'link.html', '创建超级连接'),
	Array('KE_UNLINK', 'unlink.html', '删除超级连接')
...
function KindGetBrowser()
{
	...
	if (agentInfo.indexOf("msie") > -1) {
		...
		var temp2 = temp1[temp1.length-1].split('http://demo.vhostgo.com/');
		...
		var temp1 = agentInfo.split(' ');
		var temp2 = temp1[0].split('http://demo.vhostgo.com/');
...
function KindCheckFlashFileType(file, separator)
{
	...
	var fileName = KindGetFileName(file, "http://demo.vhostgo.com/");
	var fileExt = KindGetFileExt(fileName);
	if (fileExt != 'swf') {
...
function KindImagePreview()
{
	...
	if (type == 1) {
		...
		if (KindCheckImageFileType(url, "http://demo.vhostgo.com/") == false) {
			return false;
		}
	}
...
function KindFlashPreview()
{
	...
	if (KindCheckFlashFileType(url, "http://demo.vhostgo.com/") == false) {
		return false;
	}
...
function KindMediaPreview(cmd)
{
	...
	if (KindCheckMediaFileType(cmd, url, "http://demo.vhostgo.com/") == false) {
		return false;
	}
